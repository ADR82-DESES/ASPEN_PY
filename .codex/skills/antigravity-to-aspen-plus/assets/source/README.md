...
docs/                   Maintained documentation, if present in the target project
...
Historical COM experiments, old generated Aspen files, and one-off probes are preserved under `legacy_old_files/` for reference when present.
