...
from .exceptions import BuildError, ExtractionError, ValidationError
...
from .session import _cleanup_session, run_simulation_session
...
def _build_simulation_diagnostics(
    ...
    required_kpis = _required_kpi_names(spec)
    ...
    elif stream_numeric_rows == 0 or block_numeric_rows == 0 or missing_required_kpis:
        results_status = "incomplete"
    elif not acceptance.get("passed", False):
