...
inp_content = """TITLE 'Test Syntax 4'
...
FLOWSHEET
    ...
    BLOCK B-SYN IN=S2 OUT=S3
    BLOCK B-DIST IN=S3 OUT=MEOH-PRO WASTE-H2O
STREAM S1
...
BLOCK B-DIST SEP
    FRAC MEOH-PRO COMPS=CH3OH H2O FRACS=0.99 0.001

"""
path = Path("C:\\Users\\domingueza\\ASPEN_PY\\test_syntax4.inp").resolve()
